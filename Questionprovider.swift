...
//  EnhanceQuizStarter
//
//  Created by Manish Chaturvedi on 11/10/18.
...
/*struct ObjectiveType2 {
    var question: String
    
    // Yaha pe aaray bana questions ka
...
struct Quiz {
    var questionList: [ObjectiveType2]

    // Yaha pe init mai question lkist ka array baana ker return ker
    init() {
        self.questionList =  []
    }
}
...
// Game manager ka Ek alag class bana. Nayi file mai
// Itna baan ker viewController mai aa, fir baat kerte hai
